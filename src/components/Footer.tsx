      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-finance-green">Weekly Summaries</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link to="/contact" className="text-gray-400 hover:text-finance-green">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link to="/refund-policy" className="text-gray-400 hover:text-finance-green">Refund Policy</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Eleven Square Labs. All rights reserved.
          </p>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://x.com/MarketMynds" target="_blank" className="text-gray-400 hover:text-finance-green">
            ...
            <a href="https://www.linkedin.com/company/market-mynds" target="_blank" className="text-gray-400 hover:text-finance-green">
            ...
            <a href="https://www.instagram.com/marketmynds/" target="_blank" className="text-gray-400 hover:text-finance-green">
