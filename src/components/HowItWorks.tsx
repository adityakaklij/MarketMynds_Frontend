    ...
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Step 1 */}
          <div 
            className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-xl border border-gray-800 shadow-lg hover:border-finance-green/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-finance-green/10 hover:shadow-xl cursor-pointer"
            onClick={scrollToPricing}
          >
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 bg-finance-green rounded-full flex items-center justify-center">
                <IndianRupee className="w-8 h-8 text-black" />
              </div>
            </div>
            <h3 className="text-2xl font-bold text-white text-center mb-4">Step 1</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white text-center mb-4">Step 2</h3>
            <p className="text-gray-300 text-center">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white text-center mb-4">Step 3</h3>
            <p className="text-gray-300 text-center">
